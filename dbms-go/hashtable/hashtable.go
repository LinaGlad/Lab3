...
func (h *HashTable) SaveToFile(filename string) error {
    data, err := json.MarshalIndent(h.GetAllElements(), "", "  ")
    if err != nil {
        return err
    }
...
func (h *HashTable) SaveBinary(filename string) error {
    ...
    return enc.Encode(h.GetAllElements())
}

func (h *HashTable) LoadBinary(filename string) error {
